...
setup(
    ...
    author_email='emahintorabi@zagmail.gonzaga.edu',
    description='This manages different versions of your database automatically when working on different git branches',
